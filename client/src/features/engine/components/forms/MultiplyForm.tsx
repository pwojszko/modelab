...
import { multiplyNumbers } from "../../services/engine";
...
export function MultiplyForm() {
  ...
  const handleSubmit = async (data: z.infer<typeof multiplySchema>) => {
    await multiplyNumbers(data);
  };
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)}>
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-semibold">Multiplication</h4>
          </div>
          ...
          <div className="flex items-end gap-2">
            ...
            <X className="h-4 w-4 mb-2 shrink-0" />
            <div className="flex-1">
              <Controller
                name="b"
                control={form.control}
